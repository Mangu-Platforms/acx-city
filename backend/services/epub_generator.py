...
class EPUBGenerator:
    ...
    def __init__(self, title: str, author: str, language: str = "en"):
        ...
        # EpubBook has no chapter list of its own — track ours for numbering
        # and TOC/spine assembly.
    ...
    def generate_toc(self):
        ...
        # Create TOC — ebooklib expects a flat sequence of items (or
        # (Section, items) pairs); a bare Section alongside a tuple breaks
        # its NCX walker with "'EpubHtml' object is not iterable".
        self.book.toc = list(chapters)
