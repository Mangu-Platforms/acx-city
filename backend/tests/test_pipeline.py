...
from pipeline.agents.structure_parser import StructureParser, _detect_speaker_attribution
...
from pipeline.prosody_parser import parse_tagged_text, extract_emotion_conditioning
